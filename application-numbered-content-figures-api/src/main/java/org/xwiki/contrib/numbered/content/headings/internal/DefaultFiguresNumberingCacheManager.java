...
/**
 * Default implementation of {@link FiguresNumberingCacheManager}, where the results are cached using a {@link
 * CacheManager}.
 *
 * @version $Id$
 * @since 1.0
...
@Component
@Singleton
public class DefaultFiguresNumberingCacheManager implements FiguresNumberingCacheManager, Initializable, Disposable
{
    @Inject
